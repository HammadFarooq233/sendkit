...
export const discordSendMessageResponseSchema = z.object({
...
export const discordMessageObjectSchema = z
  .object({ id: z.string() })
  .passthrough();
...
>;
export type DiscordSendMessageResponse = z.infer<
  typeof discordSendMessageResponseSchema
>;
